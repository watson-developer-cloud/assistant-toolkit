...
- [Topic 2](#parameters-variables-and-complex-actions): Using parameters and variables
- [Topic 3](#using-refs-in-openapi): Refs support
...
You are not limited to one extension per action nor assistant! You can add multiple extensions to a single action step, or across multiple actions within the same assistant (using [session variables](#parameters-variables-and-complex-actions)), and essentially mix APIs in order to create a completely custom workflow.
