...
Follow the instructions [here](https://cloud.ibm.com/docs/watson-assistant?topic=watson-assistant-search-elasticsearch-add) to set up the Elasticsearch search integration and enable dense vector search for your search extension on Watson Asistant by following the guide [here](README.md).
