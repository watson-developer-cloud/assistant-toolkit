...
### 1. Configure your assistant for document search
Use the vector representations generated by your deployed model to enhance document search in your assistant. Follow the instructions provided [here](../../starter-kits/elasticsearch/README.md) to integrate Elasticsearch as an extension into your assistant.
### 2. Use search results as input context to an LLM
