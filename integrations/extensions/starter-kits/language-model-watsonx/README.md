...
- `watsonx_generated_text_path`: The path of where watsonx Assistant must look for tokens in the stream of responses from watsonx.ai. Set to "results[0].generated_text".
