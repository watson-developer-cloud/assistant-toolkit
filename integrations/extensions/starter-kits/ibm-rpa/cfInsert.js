...
const processID = "process-id"//Developer uses a get request for list processes ( by caling: https://us1api.wdgautomation.com/v2.0/workspace/{workspace-app-id}/process) OR get it manually by going to the process in the web client
