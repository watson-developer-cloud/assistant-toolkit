...
@RequestScoped
@ReceiverComment
public class ReceiverCommentSlotHandler extends SlotHandler {
	private static String SLOT_NAME = "receiver_comment";

	public ReceiverCommentSlotHandler() {
	...
	public void onFill(State state) {
		state.getLocalVariables().put("receiver_comment", getNormalizedValue());
	}
