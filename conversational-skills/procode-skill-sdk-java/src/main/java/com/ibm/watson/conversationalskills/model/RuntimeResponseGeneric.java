...
public class RuntimeResponseGeneric {
  ...
  public RuntimeResponseGeneric channels(List<ResponseGenericChannel> channels) {
  ...
  public RuntimeResponseGeneric options(List<DialogNodeOutputOptionsElement> options) {
  ...
  public RuntimeResponseGeneric suggestions(List<DialogSuggestion> suggestions) {
  ...
  public RuntimeResponseGeneric primaryResults(List<SearchResult> primaryResults) {
  ...
  public RuntimeResponseGeneric additionalResults(List<SearchResult> additionalResults) {
  ...
  public RuntimeResponseGeneric userDefined(Map<String, Object> userDefined) {
