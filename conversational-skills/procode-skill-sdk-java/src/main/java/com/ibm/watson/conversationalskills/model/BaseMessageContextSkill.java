 ...
 */
@JsonPropertyOrder({
  BaseMessageContextSkill.JSON_PROPERTY_USER_DEFINED,
  BaseMessageContextSkill.JSON_PROPERTY_SYSTEM
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")
public class BaseMessageContextSkill {
  ...
  public BaseMessageContextSkill() {
  }

  public BaseMessageContextSkill userDefined(Map<String, Object> userDefined) {
    
    this.userDefined = userDefined;
    return this;
  }

  public BaseMessageContextSkill putUserDefinedItem(String key, Object userDefinedItem) {
  ...
  public BaseMessageContextSkill system(MessageContextSkillSystem system) {
  ...
  public boolean equals(Object o) {
    ...
    BaseMessageContextSkill baseMessageContextSkill = (BaseMessageContextSkill) o;
    return Objects.equals(this.userDefined, baseMessageContextSkill.userDefined) &&
        Objects.equals(this.system, baseMessageContextSkill.system);
  }
  ...
  public String toString() {
    ...
    sb.append("class BaseMessageContextSkill {\n");
